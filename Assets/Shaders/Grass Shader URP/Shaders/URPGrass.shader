Shader "Unlit/URPGrass"
{
    ...
    SubShader
    {
        //faz com que a Unity Reconheca o modo de Iluminaçao Universal URP
        Tags { "RenderType"="Opaque" "RenderPipeline"="UniversalPipeline"}
        LOD 100

        //pass apenas para profundidade
        Pass
        {
            Name "Depth Pass"
        ...
        //URP na Unity suporta apenas um Pass, uma das maneiras para utilizar mais Pass é adicionar multiplos materias na malha
        Pass
        {   
            //nome do pass e a teg do modo de iluminaçao
            Name "Geometry Pass"
            Tags {"RenderType" = "Opaque" "LightMode"="UniversalForward"}


            //ZWrite e cull faz com que os 2 lados do plano sejão renderizados
            ZWrite On
            Cull Off

            //a URP so funciona com HLSL não funciona com CG que faz com que o matrial fique roza
            HLSLPROGRAM
